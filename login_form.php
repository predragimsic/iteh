<form action="login.php" method="post" id="form1">
    ...
    <input type="text" name="username" class="form-control input-sm chat-input" placeholder="Username" data-icon="u" />
    </br><br>
    ...
    <div class="wrapper">
        <span class="group-btn">
            <input type="submit" class="btn btn-primary" value="Log in" style="width:100px;" />
        </span>
        <p class="change_link">
            Not a member yet ?
